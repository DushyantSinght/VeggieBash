...
// Place Order with COD
    ...
    try {
      ...
      if (data.success) {
        setCartItems(data.cartItems); // restore cart
      }
    } catch (err) {
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <span className="text-sm greenc">{getCartCount()} Items</span>
                </h1>
                ...
                <button onClick={()=>{navigate("/products"); scrollTo(0,0)}} className="group cursor-pointer flex items-center mt-8 gap-2 greenc
                 font-medium">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        <button onClick={() => setShowAddress(!showAddress)} className="greenc hover:underline cursor-pointer">
                            Change
                        </button>
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate("/add-address")} className="greenc text-center cursor-pointer p-2 hover:bg-indigo-500/10">
                                    Add address
                                </p>
                            </div>
                        )}
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer green text-white font-medium hover:bg-indigo-600 transition">
